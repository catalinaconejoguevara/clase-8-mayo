...
<p>Este Kit está instalado en: <strong><?php echo ($datos["data"]["location"]["country"]);?></strong> </p>
<p>La temperatura de ese lugar es:
<strong><?php echo round($datos["data"]["sensors"][3]["value"],2);?></strong></p>
<p>La humedad ambiental es:
<strong><?php echo round($datos["data"]["sensors"][2]["value"],2);?></strong></p></p>
<p>La iluminación:
<strong><?php echo round($datos["data"]["sensors"][0]["value"],2);?></strong></p></p>
